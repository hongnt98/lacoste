...
(function($){
    (function(window, mapster){
      ...
      var element = document.getElementById('amlocator-map-canvas');
...
//           mapTypeId: 'terrain'})
      ...
      var searchBox = new google.maps.places.SearchBox(document.getElementById('amlocator-search'));
